...
class InvalidNetworkMessageViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.closeButton?.setGradientColor(from: AppDelegate.appConfigColor("MessageButtonLeftColor"), to: AppDelegate.appConfigColor("MessageButtonRightColor"), startPoint: CGPoint(x: -0.4, y: 0.5), toPoint: CGPoint(x: 1, y: 0.5))
